...
def extract_repeated_with_prefix(data: dict[str, Any], group: str, prefix: str) -> dict[str, Any]:
    extracted = {}
...
def serialize_repeated_with_prefix(data: dict[str, Any], group: str, prefix: str) -> dict[str, Any]:
