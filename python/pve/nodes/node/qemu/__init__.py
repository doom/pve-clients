...
class PostParameters(BaseModel):
    ...
    @classmethod
    def rewrite_for_hostpcis(cls, data: Any) -> Any:
        if isinstance(data, dict):
            data = extract_repeated_with_prefix(
    ...
    @model_validator(mode="before")
    @classmethod
    def rewrite_for_ides(cls, data: Any) -> Any:
        if isinstance(data, dict):
    ...
    @model_validator(mode="before")
    @classmethod
    def rewrite_for_ipconfigs(cls, data: Any) -> Any:
        if isinstance(data, dict):
            data = extract_repeated_with_prefix(
    ...
    @model_validator(mode="before")
    @classmethod
    def rewrite_for_numas(cls, data: Any) -> Any:
        if isinstance(data, dict):
    ...
    @model_validator(mode="before")
    @classmethod
    def rewrite_for_parallels(cls, data: Any) -> Any:
        if isinstance(data, dict):
            data = extract_repeated_with_prefix(
    ...
    @model_validator(mode="before")
    @classmethod
    def rewrite_for_satas(cls, data: Any) -> Any:
        if isinstance(data, dict):
    ...
    @model_validator(mode="before")
    @classmethod
    def rewrite_for_scsis(cls, data: Any) -> Any:
        if isinstance(data, dict):
    ...
    @model_validator(mode="before")
    @classmethod
    def rewrite_for_serials(cls, data: Any) -> Any:
        if isinstance(data, dict):
    ...
    @model_validator(mode="before")
    @classmethod
    def rewrite_for_usbs(cls, data: Any) -> Any:
        if isinstance(data, dict):
    ...
    @model_validator(mode="before")
    @classmethod
    def rewrite_for_virtios(cls, data: Any) -> Any:
        if isinstance(data, dict):
