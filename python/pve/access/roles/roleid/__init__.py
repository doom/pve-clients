...
class GetResponseItem(BaseModel):
    ...
    mapping_audit: Optional[bool] = Field(alias="Mapping.Audit", default=None)
    mapping_modify: Optional[bool] = Field(alias="Mapping.Modify", default=None)
    mapping_use: Optional[bool] = Field(alias="Mapping.Use", default=None)
    ...
    sys_access_network: Optional[bool] = Field(alias="Sys.AccessNetwork", default=None)
